...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('customer/portal')->group(function () {
        ...
        Route::patch('/orders/{salesTransaction}/items', [CustomerPortalController::class, 'updateOrderItems']);
        ...
        Route::post('/billing/payment-proofs/scan', [CustomerPortalController::class, 'scanPaymentProof']);
